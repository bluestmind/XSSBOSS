...
def main():
    ...
    try:
        ...
        print("    1. Ensure OPENAI_API_KEY is set in .env (Regolo AI API key).")
        print("    2. If using Ollama, ensure your local Ollama server is running (ollama serve).")
        print("    3. Check that the LLM_API_URL endpoint is reachable.")
    print("=" * 75)
