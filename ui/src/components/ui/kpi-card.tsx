...
/**
 * KPI Card — 21st.dev component by @nayan_radadiya6 (id 6535), used verbatim.
 * Source: https://21st.dev/@nayan_radadiya6/components/kpi-card
 * Dependency-light: only `cn` + lucide-react.
 */
