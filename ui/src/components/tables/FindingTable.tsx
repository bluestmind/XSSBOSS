        ...
        <table className="min-w-full divide-y divide-carbon-700/50">
          ...
          <tbody className="bg-carbon-800/70 divide-y divide-carbon-700/50">
            {findings.map((finding) => (
              <tr key={finding.id} className="hover:bg-carbon-850/50">
                ...
                <td className="px-6 py-4">
                  <code className="text-sm text-carbon-100 font-mono break-all">
                  ...
                  {onViewPoC && (
                    <>
                      <button
                        ...
                        className="text-brand-300 hover:text-brand-100 mr-4 font-semibold"
                      >
                        View Details
                      </button>
                      <button
