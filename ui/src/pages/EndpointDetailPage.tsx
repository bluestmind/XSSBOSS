...
const EndpointDetailPage = () => {
  ...
  if (!endpoint) {
    return (
      <div className="p-6">
        <p className="text-red-300">Endpoint not found</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <Link to={`/targets/${endpoint.target_id}`} className="text-brand-300 hover:text-brand-200 text-sm mb-2 inline-block">
          ← Back to Target
        </Link>
        <div className="flex items-center space-x-3">
          ...
          <code className="text-lg font-mono text-carbon-100">{endpoint.url_pattern}</code>
        </div>
      ...
      {/* Parameters */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-carbon-100 mb-4">Parameters</h2>
      ...
      {contexts.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-carbon-100 mb-4">Reflection Contexts</h2>
      ...
      {filterProfile && (
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-carbon-100 mb-4">Filter Profile</h2>
