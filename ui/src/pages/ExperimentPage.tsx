  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-carbon-100">Experiments</h1>
        <button
        ...
        {selectedExperiment && (
          <div className="lg:col-span-1">
            <div className="bg-carbon-800/70 rounded-lg shadow p-6">
              <h2 className="text-lg font-semibold text-carbon-100 mb-4">Experiment Details</h2>
              
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium text-carbon-200">Name</p>
                  <p className="text-sm text-carbon-100">{selectedExperiment.name}</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-carbon-200">Strategy</p>
                  <p className="text-sm text-carbon-100">{getStrategyLabel(selectedExperiment.strategy)}</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-carbon-200">Status</p>
                ...
                {stats && (
                  <div>
                    <p className="text-sm font-medium text-carbon-200 mb-2">Progress</p>
