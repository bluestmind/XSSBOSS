  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-carbon-100">Findings</h1>
      </div>
      ...
      {/* Filters */}
      <div className="bg-carbon-800/70 rounded-lg shadow p-4 mb-6">
        <div className="flex items-center space-x-4">
          <div>
            <label className="block text-sm font-medium text-carbon-200 mb-1">Severity</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-carbon-200 mb-1">Status</label>
            <select
              value={statusFilter}
