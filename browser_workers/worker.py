    ...
    try:
        ...
        if non_final_count == 0:
            ...
            if experiment and experiment.status == ExperimentStatus.RUNNING:
                ...
                experiment.target.status = TargetStatus.TRIAGE if campaign_findings else TargetStatus.DONE
                db.commit()
    ...
    try:
        ...
        if test_case.status == TestCaseStatus.COMPLETED:
            ...
            return {
                ...
                'oracle_hit': bool(existing_execution and existing_execution.oracle_status == OracleStatus.HIT),
