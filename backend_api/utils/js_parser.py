...
class JSParser:
    ...
    DANGEROUS_SINKS = [
        ...
        {
            'pattern': r'\$sce\.trustAs(Html|Js|ResourceUrl)\s*\(',
            'type': 'angular_trustAs',
            'description': 'AngularJS $sce trust bypass sink'
        },
        {
            'pattern': r'parseHTMLUnsafe\s*\(',
            'type': 'parseHTMLUnsafe',
            'description': 'parseHTMLUnsafe() HTML parser sink'
        },
        {
        ...
        },
        {
            ...
            'type': 'serviceWorker_register',
            'description': 'ServiceWorker registration sink'
        },
        {
            'pattern': r'(?:Object\.assign|\$\.extend|_\.(?:merge|defaultsDeep))\s*\(',
            'type': 'prototype_pollution_sink',
            'description': 'Recursive merge / prototype pollution sink'
        }
    ]
