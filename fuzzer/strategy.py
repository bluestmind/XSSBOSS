...
class StrategyProfile:
    ...
    PROFILES: Dict[Strategy, Dict[str, Any]] = {
        Strategy.POLYGLOT_FIRST: {
            'name': 'Polyglot-First Triage',
            'description': 'High information density multi-context triage on Request #1 before targeted mutation',
            'max_payloads_per_context': 15,
            'mutation_probability': 0.5,
            'use_unicode': True,
            'use_encoding': True,
            'use_keyword_splitting': True,
            'preferred_contexts': ['HTML_TEXT', 'ATTR_QUOTED', 'ATTR_UNQUOTED', 'JS_STRING_LITERAL'],
            'mutation_strategy': 'polyglot_first'
        },
        ...
        Strategy.SMART_ADAPTIVE: {
            'name': 'Smart Adaptive',
            'description': 'Fast context-aware coverage with a compact set of high-signal bypass variants',
            'max_payloads_per_context': 12,
            'mutation_probability': 0.5,
            'use_unicode': True,
            'use_encoding': True,
            'use_keyword_splitting': True,
            'preferred_contexts': [
                ...
                'EVENT_HANDLER_ATTR', 'JS_STRING_LITERAL', 'JS_IDENTIFIER',
                'URL_QUERY', 'URL_FRAGMENT', 'JSON_VALUE'
            ],
            'mutation_strategy': 'smart_adaptive'
        },
